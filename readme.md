...
**4. number of DNs: p, and number of data packets each DN has: q. 
Here we assume each DN has the same number of data 
packets.**
...
**Second**, your program should check if the user inputs satisfy: p x q <= (N-p) x m (i.e., feasibility). 
...
please ask the user to make choice when executing your program: 
  
  1. for shortest path; 

  2. for minimum spanning tree.
